...
<script>
import * as NavigationMenuPrimitive from '@radix-ui/vue-navigation-menu'
...
<template>
  <NavigationMenuPrimitive.List
    ref="listRef"
    :class="cn('group flex flex-1 list-none items-center justify-center space-x-1', $attrs.class)"
    v-bind="$attrs"
  >
    <slot />
  </NavigationMenuPrimitive.List>
...
<template>
  <NavigationMenuPrimitive.Trigger
    ref="triggerRef"
    :class="[navigationMenuTriggerStyle(), 'group', $attrs.class]"
    v-bind="$attrs"
  >
    <slot />
    <ChevronDown
...
<script>
// Экспорт всех компонентов навигационного меню
import * as NavigationMenuPrimitive from '@radix-ui/vue-navigation-menu'
